...
set JAVA_VERSION=17
set MAIN_JAR=gleonismastodonfx-%PROJECT_VERSION%.jar
...
"%JAVA_HOME%\bin\jdeps" ^
  ...
  --print-module-deps target\classes\eus\ehu\gleonis\gleonismastodonfx\MainApplication.class > temp.txt
...
set manual_modules=,jdk.crypto.ec,jdk.localedata,java.xml,java.scripting,jdk.unsupported,javafx.controls,javafx.fxml,javafx.graphics,javafx.web,javafx.media
